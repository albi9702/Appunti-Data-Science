...
```{r Non Linear Programin Graphic, echo=FALSE, fig.align='center', out.width="75%"}
...
```{r Punto di Massimo Locale, echo=FALSE, fig.align='center', out.width="65%"}
...
```{r Tipologie di Metaeuristiche, echo=FALSE, fig.align='center', out.width="85%"}
...
```{r Simulated Annealing, echo=FALSE, fig.align='center', out.width="75%"}
...
```{r Tabu-Search, echo=FALSE, fig.align='center', out.width="75%"}
